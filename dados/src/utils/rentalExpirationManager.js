...
🤖 *Obrigado por usar nossos serviços! Até breve!*`;
  ...
  async getOwnerInfo() {
    try {
      ...
      const number = this.ownerNumber || process.env.OWNER_NUMBER || '258852931823';
      ...
      return {
        ...
        number: this.ownerNumber || '258852931823',
        contact: `${this.ownerNumber || '258852931823'}@s.whatsapp.net`
      };
    }
  }
